...
//  in-App Purschase
//
//  Created by Sparkout on 04/01/23.
//
...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, SKProductsRequestDelegate, SKPaymentTransactionObserver {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "Monthly Subscription - \(product.priceLocale.currencySymbol ?? "$")\(product.price)"
        return cell
    }
    ...
    enum Products: String, CaseIterable {
        case MonthlyTen = "MonthlySubscriptionTen"
        case Monthly15 = "monthly15"
        case monthlySubscription = "MonthlySubscription"
    }
